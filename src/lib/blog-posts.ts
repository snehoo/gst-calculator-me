...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "faq", items: [
        ...
        { q: "How do I calculate CGST and SGST on an amount?", a: "Halve the GST rate and apply each half to the taxable value. On ₹10,000 at 18% GST: CGST = 10,000 × 9% = ₹900 and SGST = 10,000 × 9% = ₹900, for ₹1,800 total tax. A GST calculator does this split automatically for any slab." },
  ...
  },
  {
    ...
    description:
      "What is Input Tax Credit in GST? Plain-English meaning with a worked example, the ITC formula, how to calculate and claim it, the utilisation order, blocked credits, and the 180-day rule.",
    category: "Tax Credit",
    readTime: "6 min",
    date: "2026-04-20",
    updated: "2026-07-11",
  ...
  },
  {
    ...
    title: "GST vs VAT 2026: 55+ Global Statistics on Tax Rates, Adoption & Revenue",
    description: "India's GST vs global VAT: 55+ data points on country rates, adoption, tax structure, and revenue share. OECD, IMF, and RBI sources.",
    category: "Statistics",
    readTime: "7 min",
    date: "2026-05-03",
    updated: "2026-08-05",
  ...
  },
  {
    ...
    title: "TaxAdda GST Calculator — Free, Instant, No Login (vs ClearTax 2026)",
    description: "Free GST calculator like TaxAdda — instant CGST/SGST/IGST, all slabs, no account. Plus: full TaxAdda vs ClearTax head-to-head so you know which tool fits your needs.",
    category: "Comparison",
    readTime: "5 min",
    date: "2026-05-03",
    updated: "2026-08-05",
    ...
    body: [
      ...
      { type: "p", text: "If you're curious how India's multi-slab GST system compares to the single-rate VAT used in most other countries, our <a href=\"/blog/gst-vs-vat-global-comparison-statistics\">GST vs VAT global statistics comparison</a> has 55+ data points from OECD, IMF, and RBI sources." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "For a broader look at how GST 2.0 restructured rates across all sectors — not just food — see the <a href=\"/blog/gst-2-0-reforms-india-2025\">GST 2.0 reforms overview</a>. To calculate the exact CGST/SGST split on your restaurant bill (whether 5% or 18%), use the <a href=\"https://gstcalculator.me\">free GST calculator</a> — no login required. And if you're wondering how India's GST compares to VAT systems in countries where your suppliers or customers are based, our <a href=\"/blog/gst-vs-vat-global-comparison-statistics\">GST vs VAT global comparison</a> covers the key differences in rate structure and compliance burden." },
  ...
  },
  {
    ...
    title: "TaxAdda GST Calculator: Free, No Login — All GST 2.0 Slabs (2026)",
    description: "Need a TaxAdda-style GST calculator? gstcalculator.me is faster, no login needed, all GST 2.0 slabs (5%, 18%, 40%), instant CGST/SGST/IGST. Free forever.",
    category: "Tools & Guides",
    readTime: "10 min",
    date: "2025-05-13",
    updated: "2026-08-05",
