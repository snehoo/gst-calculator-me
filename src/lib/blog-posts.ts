...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "h2", text: "Your 4 Free Options After a ClearTax Subscription Cancellation" },
      ...
      { type: "h2", text: "How to Migrate Your Data Off ClearTax Before Switching" },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "The market for <strong>free GST calculators with no login in India</strong> has grown considerably since 2017, and quality varies enormously. Some tools are genuinely purpose-built for fast calculation. Others are marketing pages dressed up as calculators. A few are excellent tools buried inside slow-loading websites. This guide separates them clearly — tested on desktop and mobile, in Chrome and Safari, across all major GST slabs — so you know exactly which one to bookmark." },
  ...
  },
  {
    ...
    title: "TaxAdda GST Calculator: Features, Limits & a Faster Free Alternative",
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "<strong>Can I use Zoho's GST calculator without signing up for Zoho Books?</strong> Yes — the basic calculator at zoho.com/in/books/free-gst-calculator works without any account. You get three input fields and an immediate result. That's the complete no-login experience. Any feature beyond that — invoicing, filing, GSTIN lookup — requires a Zoho account." },
      { type: "p", text: "<strong>Does the Zoho Books free plan require a login every time?</strong> Yes. Zoho Books is a cloud application — every session requires authentication. Sessions typically last several days on trusted devices before requiring OTP re-verification. On new devices or after clearing browser data, you'll need to log in and verify your identity via OTP each time." },
      { type: "p", text: "<strong>Why does Zoho ask for my GSTIN and business details just to calculate GST?</strong> Zoho's free account setup collects business details because it's configuring a full accounting organisation, not just a calculator. The GSTIN is required to generate compliant invoices and connect to the GSTN portal for filing. If you only need arithmetic, this setup is unnecessary — a dedicated calculator handles the maths without any business data." },
      { type: "p", text: "<strong>Does GSTCalculator.me ever require login or account creation?</strong> No — not for any feature, now or in the future. GSTCalculator.me is built specifically to avoid this friction. Enter your amount, pick your slab, get your result. That's the entire workflow, and it never changes regardless of how often you use it." },
